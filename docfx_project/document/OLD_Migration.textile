...
Note that if you use SQL Server identity columns "see WithIdentityInsert":https://github.com/schambers/fluentmigrator/wiki/Sql-Server-Specific-Extensions#withidentityinsert
