...
h2. Command Line Runner

For a full listing of options simply run migrate.exe from the command line by itself or check the [[Command Line Runner Options]].
...
See [[Nant Runner Options]] for a complete list of options.
...
See [[MSBuild Runner Options]] for a complete list of options.
