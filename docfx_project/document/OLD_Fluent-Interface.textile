...
```
Example extensions can be found in the "example MigrationExtensions.cs.":https://github.com/schambers/fluentmigrator/blob/master/src/FluentMigrator.Example/FluentMigrator.Example/Migrations/MigrationExtensions.cs
