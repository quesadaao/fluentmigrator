...
h3. <notextile>--assembly, -a, --target=VALUE (required)</notextile>

The assembly containing the migrations you want to execute.

h3. <notextile>--provider, --dbtype, --db=VALUE (required)</notextile>
...
h3. <notextile>--connectionString, --connection, --conn, -c=VALUE</notextile> (required or @connectionStringName@)
...
h3. <notextile>--connectionStringConfigPath, --configPath=VALUE</notextile>
...
h3. <notextile>--task, -t=VALUE (optional)</notextile>
...
h3. <notextile>--verbose=VALUE (optional)</notextile>
...
h3. <notextile>--output, --out, -o (optional)</notextile>
...
h3. <notextile>--outputFilename, --outfile, --of=VALUE (optional)</notextile>
...
h3. <notextile>--namespace, --ns=VALUE (optional)</notextile>
...
h3. <notextile>--nested (optional)</notextile>
...
h3. <notextile>--steps=VALUE (optional)</notextile>

The number of versions to rollback if the task is 'rollback'. Default is 1.

h3. <notextile>--preview, -p (optional)</notextile>
...
h3. <notextile>--version=VALUE (optional)</notextile>
...
h3. <notextile>--help, -h, -?</notextile>

Displays help menu.

h3. <notextile>--providerswitches=VALUE</notextile>
